...
const States = () => {
    return (
        <div className='md:my-10'>
            ...
            <div className="stats flex flex-col shadow w-full bg-[#632EE3] text-white rounded-lg py-6 md:py-10 mx-0 auto">
                <h1 className='text-xl sm:text-2xl md:text-3xl font-bold text-center mb-6'>Trusted by Millions, Built for You</h1>
